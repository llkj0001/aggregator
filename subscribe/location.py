...
def locate(proxy: dict, reader: database.Reader, emoji_patterns: dict = None) -> dict:
...
def rename(
    ...
    proxies = utils.multi_thread_run(func=locate, tasks=tasks, num_threads=num_threads, show_progress=show_progress)

    records = defaultdict(list)
    for proxy in proxies:
        records[proxy.get("name", "")].append(proxy)
